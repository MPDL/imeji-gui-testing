...
public class MoveItems extends BaseSelenium {
  ...
  public void uploadItemsToFirstCollection() {
    String[] items = {"APC_Springer_Psycholinguistik_201609.xlsx", "APC_Springer_Stoffwechselforschung_201608.xlsx",
        ...
        "JR2_SpringerProtocols_Springer_Wissenschaftsgeschichte_2009.csv", "outbox_doku_apcreports.pdf", "outbox_doku_dateiformate.pdf",
        "SampleCSVFile.csv", "SampleJPGFile.jpg", "SampleJPGFile2.jpg", "SampleMP3File.mp3", "SamplePDFFile.pdf", "SamplePNGFile.png",
        "SampleSWCFile.swc", "SampleTIFFile.tif", "SampleTXTFile.txt", "SampleWordFile.docx", "SampleXLSXFile.xlsx"};
  ...
  public void moveSelectedItemsToPrivateCollection() {
    String[] items = {"SampleJPGFile.jpg", "SampleJPGFile2.jpg", "SampleMP3File.mp3", "SamplePDFFile.pdf", "SamplePNGFile.png",
        "SampleSWCFile.swc", "SampleTIFFile.tif", "SampleTXTFile.txt", "SampleWordFile.docx", "SampleXLSXFile.xlsx"};
