...
public class OneAuthorTwoOUs extends BaseSelenium {
  ...
  public void createCollection() {
    ...
    collectionEntry = newCollectionPage.createCollection1Author2OUs(collectionTitle, collectionDescription, null,
  ...
  //    @Test(priority = 27, dependsOnMethods = { "createCollection" })
