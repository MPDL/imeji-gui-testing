...
public class ThreeAuthors extends BaseSelenium {
  ...
  public void createCollection3Authors() {
    ...
    collectionEntry = newCollectionPage.createCollection3Authors(collectionTitle, collectionDescription, null,
  ...
  //    @Test(priority = 27, dependsOnMethods = { "createCollection3Authors" })
