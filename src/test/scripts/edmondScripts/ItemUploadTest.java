...
public class ItemUploadTest extends BaseSelenium {
	...
	private CollectionEntryPage collectionContent;
	...
	public void createPrivateCollection() {
		homePage.goToCreateNewCollectionPage().createCollection(collectionTitle, "",
	...
	public void uploadAndRelease() {
		...
		CollectionEntryPage collectionEntry = collectionContent.openDescription().releaseCollection();
	...
	public void uploadReleased() {
		...
		try {
			MultipleUploadPage multipleUpload = collectionContent.openDescription().uploadContent();
